...
const sendEmail = async (mailOptions) => {
    try {
        const options = {
            ...mailOptions,
            from: `"Dev_Community Team" <${process.env.GMAIL_USER}>`,
        };
...
You have requested to reset your password for your Dev_community account.
...
Best regards,
The DevCommunity Team`;
    const html = `
    <div style="font-family: Arial, sans-serif; line-height: 1.6;">
        <h2>Reset Your DevCommunity Password</h2>
        <p>Hello,</p>
        <p>You have requested to reset your password for your DevCommunity account.</p>
        ...
        <hr>
        <p>Best regards,<br>The DevCommunity Team</p>
    </div>`;
...
const sendWelcomeEmail = async (to, firstName) => {
    const subject = "Welcome to the Dev community! 🎉";
    const text = `Welcome to Community Devs, ${firstName}! 🚀
...
Need help? Contact Support: devcommunity6@gmail.com

© 2025 DevCommunity | All rights reserved.`;

    const html = `
    <div style="font-family: Arial, sans-serif; line-height: 1.6;">
        <h2>Welcome to Community Devs, ${firstName}! 🚀</h2>
        ...
        <hr>
        <p>Need help? Contact Support: <a href="mailto:devcommunity6@gmail.com">devcommunity6@gmail.com</a></p>
        <p><small>© 2025 DevCommunity | All rights reserved.</small></p>
    </div>`;
...
Community for Devs Team`;
    ...
    <div style="font-family: Arial, sans-serif; line-height: 1.6;">
        ...
        <hr>
        <p>Best,<br>Community for Devs Team</p>
    </div>`;
